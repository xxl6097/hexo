...
module.exports = function(idProperty, getEngine) {
  ...
  describe('#find()', function () {
    ...
    it('should return array of objects that match all properties in query ', function (done) {
      getEngine(function (error, engine) {
        async.mapSeries([ { findTest: 1 }, { findTest: 1 }, { findTest: 1 }, { b: 1 } ], engine.create, function () {
    ...
    it('should allow $gt operator', function (done) {
      getEngine(function (error, engine) {
        async.mapSeries([ { findTest: 1 }, { findTest: 2 }, { findTest: 3 }, { findTest: 4 } ], engine.create, function () {
    ...
    it('should allow $lt operator', function (done) {
      getEngine(function (error, engine) {
        async.mapSeries([ { findTest: 0.8 }, { findTest: 1.9 }, { findTest: 3 }, { findTest: 4 } ], engine.create, function () {
    ...
    it('should return all objects with properties in a given array ($in)', function (done) {
      getEngine(function (error, engine) {
        async.mapSeries([ { findTest: 1 }, { findTest: 2 }, { findTest: 3 } ], engine.create, function () {
    ...
    it('should return array of objects that match specified fields of a subdocument in query', function (done) {
      getEngine(function (error, engine) {
        async.mapSeries([ { findTest: { nested: 1 } }, { findTest: { nested: 1 } }, { findTest: { nested: 2 } }, { b: 1 } ], engine.create, function () {
    ...
    it('should return array of all objects for an empty query {}', function (done) {
      getEngine(function (error, engine) {
        async.mapSeries([ { a: 1 }, { a: 1 }, { a: 1 }, { b: 1 } ], engine.create, function () {
    ...
    it('should support { fields: {} } projection in options', function (done) {
      getEngine(function (error, engine) {
        async.mapSeries([ { a: 1, b: 1 }, { a: 2, b: 2 }, { b: 3, c: 3 }, { b: 4, c: 4 } ], engine.create, function () {
    ...
    it('should support { limit: n } property in options', function (done) {
      getEngine(function (error, engine) {
        async.mapSeries([ { a: 1, b: 1 }, { a: 2, b: 2 }, { b: 3, c: 3 }, { b: 4, c: 4 } ], engine.create, function (error) {
          if (error) return done(error)
          engine.find({}, { sort: { b: 1 }, fields: { b: 1, c: 1 }, limit: 1 }, function (error, objects) {
            objects.map(function(object) { delete object._id; return object })
              .should.eql([ { b: 1 } ])
            done()
          })
    ...
    it('should return array of objects in ascending order', function (done) {
      getEngine(function (error, engine) {
        async.mapSeries([ { a: 3 }, { a: 1 }, { a: 2 } ], engine.create, function () {
    ...
    it('should return a new cloned object', function (done) {
      ...
      getEngine(function (error, engine) {
        async.mapSeries([ item ], engine.create, function (error, createdObject) {
